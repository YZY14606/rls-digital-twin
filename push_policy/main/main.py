...
from main_utils import (pointcloud_segmentation_fusion,build_local_frame,First_path_plan,plan_from_waypoint,get_future_pose,get_current_pc_future_pose,
...
def main():
    ...
    for key in range(3): 
        ...
        points_wld_frame = collect_and_segmented_pcd(simulation_control = simulation_control,topic = topic,fetch = fetch)
        break
    print(points_wld_frame.shape)
    pcd = o3d.geometry.PointCloud()
    pcd.points = o3d.utility.Vector3dVector(points_wld_frame)
    o3d.visualization.draw_geometries([pcd])
    print("Point cloud bounds:")
    print("Min:", points_wld_frame.min(axis=0))
    print("Max:", points_wld_frame.max(axis=0))
    print("Center:", points_wld_frame.mean(axis=0))
    ...
    #     camera_name_list = ['camera_1','camera_2','camera_3']
    #     topic = dict()
    #     topic['camera_1'] = ['/camera_1/rgb/image_raw','/camera_1/depth/image_raw']
    #     topic['camera_2'] = ['/camera_2/rgb/image_raw','/camera_2/depth/image_raw']
    #     topic['camera_3'] = ['/camera_3/rgb/image_raw','/camera_3/depth/image_raw']
